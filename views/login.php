...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($controller->getUserModel()->login($_POST['username'], $_POST['password'])) {
        header('Location: index.php');
        exit;
    } else {
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="card shadow-lg p-4">
                        <h3 class="mb-4 text-center text-primary">Welcome Back</h3>
                        <?php if (isset($error)): ?>
                        ...
                        <p class="mt-3 text-center">Don't have an account? <a href="register.php" class="text-decoration-none text-primary">Register here</a></p>
                    </div>
                </div>
            </div>
        </div>
